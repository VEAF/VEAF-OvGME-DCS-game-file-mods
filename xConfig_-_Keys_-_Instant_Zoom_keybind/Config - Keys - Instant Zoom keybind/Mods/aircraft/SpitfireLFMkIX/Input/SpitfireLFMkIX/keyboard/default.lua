...
{combos = {{key = 'Q', reformers = {'RCtrl'}}},             pressed = device_commands.Button_5, cockpit_device_id = devices.CLOCK, value_pressed = -1.0, name = _('Input.SpitfireLFMkIX.clock_minus'), category = _('Front Dash')},
{combos = {{key = 'Q', reformers = {'RAlt'}}},              pressed = device_commands.Button_5, cockpit_device_id = devices.CLOCK, value_pressed = 1.0, name = _('Input.SpitfireLFMkIX.clock_plus'), category = _('Front Dash')},
...
{combos = {{key = 'Q', reformers = {'RShift'}}},            down = device_commands.Button_7, cockpit_device_id = devices.CLOCK, value_down = 1.0, name = _('Input.SpitfireLFMkIX.clock_mode'), category = _('Front Dash')},
