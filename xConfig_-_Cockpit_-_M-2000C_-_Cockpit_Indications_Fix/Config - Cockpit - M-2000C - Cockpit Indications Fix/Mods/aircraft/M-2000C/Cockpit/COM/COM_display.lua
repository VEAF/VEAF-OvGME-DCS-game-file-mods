...
local	text_COM_UHF1					      = CreateElement "ceStringPoly"
		...
		text_COM_UHF1.material			  = COM_greenbox_font                      -- COM_gauge_font
		text_COM_UHF1.init_pos			  = {0.95,0.3}                             -- {0.9,0.35}
		text_COM_UHF1.alignment			  = "RightCenter"
		text_COM_UHF1.formats			    = {"%03.2f"}
		text_COM_UHF1.stringdefs		  = {0.0048,0.0048}                        -- {0.009,0.009}
...
local	text_COM_UHF2					      = CreateElement "ceStringPoly"
		...
		text_COM_UHF2.material			  = COM_greenbox_font                      -- COM_gauge_font
		text_COM_UHF2.init_pos			  = {0.95,-0.3}                            -- {0.9,-0.35}
		text_COM_UHF2.alignment			  = "RightCenter"
		text_COM_UHF2.formats			    = {"%03.2f"}
		text_COM_UHF2.stringdefs		  = {0.0048,0.0048}                        -- {0.009,0.009}
...
local	text_COM_UHF2					      = CreateElement "ceStringPoly"
		...
		text_COM_UHF2.formats			    = {"%03.2f"}
		text_COM_UHF2.stringdefs		  = {0.0048,0.0048}                        -- {0.009,0.009}
		text_COM_UHF2.controllers 		= {{"COM_VIS"}, {"COM_VHF",0}}
Add_COM_Element(text_COM_UHF2)
--]]
