...
{	down = hotas_commands.THROTTLE_COMMS_COMM1,						up = hotas_commands.THROTTLE_COMMS_COMM1,						cockpit_device_id = devices.HOTAS,	value_down =  0.2,	value_up = 0.0,	name = _('COMM Switch - COMM 1'),							category = {_('Throttle Grip'), _('HOTAS')}},
{	down = hotas_commands.THROTTLE_COMMS_COMM2,						up = hotas_commands.THROTTLE_COMMS_COMM2,						cockpit_device_id = devices.HOTAS,	value_down =  0.4,	value_up = 0.0,	name = _('COMM Switch - COMM 2'),							category = {_('Throttle Grip'), _('HOTAS')}},
...
{	down = hotas_commands.THROTTLE_EXTERIOR_LIGTHS,			up = hotas_commands.THROTTLE_EXTERIOR_LIGTHS,		cockpit_device_id = devices.HOTAS,					value_down =  1.0,	value_up = 0.0,	name = _('Exterior Lights Switch (special) - ON/OFF'),							category = {_('Special For Joystick'), _('Throttle Grip'), _('HOTAS')}},
