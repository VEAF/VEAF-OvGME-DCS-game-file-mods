...
Emitters = {
		...
		InitPositionBox = {Min = {0.3,0.4,0.6}, Max = {0.3,0.5,2.6}}, -- {Min = {-1.2,0.8,0.3}, Max = {-1.2,1,1.3}},
		Flags = {"SoftParticles"},
        
        Number = {{0, 3}, {1, 1}},
--		NumberRate  = {{-3, 1}, {0,0.125}},
        Life = {{0.0, 3.6}}, -- {{0.0, 1.8}}
        ...
        SizeOverLife = {{0.6, 2} , {1, 0.1}}, -- {{0.6, 1} , {1, 0.1}},
    ...
    },
	{
		...
		Texture = "DCSFireTex.png",
        Technique = "AnimatedFire",
		InitPositionBox = {Min = {0.5,0.25,0}, Max = {0.5,0.3,0}}, -- {Min = {1.8,0.5,-0.7}, Max = {2.0,0.6,-0.9}},
		Flags = {"SoftParticles"},
        
        Number = {{0, 3}, {1, 1}},
 --       NumberRate  = {{-8, 1}, {-5, 0}},
        Life = {{0.0, 3.2}}, -- {{0.0, 1.6}}
...
--        NumberRate  = {{-2, 1}, {0, 0.33}},
        Life = {{0.0, 4.0*smokeLifeC}, {1.0, 9.0*smokeLifeC}},
        
		ShaderParams = {{0, {-0.2, 0.3, 10, 0}, {0.2, -0.2, 10, 0}}},

        Velocity = { {0, {1.2, 6, 1.2}, {-1.2, 10, -1.2}}}, -- { {0, {-1.2, 7.0, -1.2}, {1.2, 9.0, 1.2}}}, -X, {+X, +Y, +Z}, {+X, +Y, +Z}
        VelocityOverLife = { {0, 1.2}, {0.9, 1}, {1, 0.1}}, -- { {0,1.2}, {1,1}},

		ParentVelocity = { {0, 0.15} },
		
		Size = {{0.0, 30}, {1.0, 30}}, -- {{0.0, 10}, {1.0, 14}},
        SizeOverLife = {{0, 0.5}, {0.6, 3.0}, {0.9, 10}, {1, 30}}, -- {{0, 0.5}, {0.6, 3.0}, {1, 12}},

        RedOverLife =   {{0, 0.2}, {0.25, 0.58}}, -- {{0, 0.7}, {1*fireLife/smokeLife,0.3}},
        GreenOverLife = {{0, 0.2}, {0.25, 0.58}}, -- {{0, 0.1}, {1*fireLife/smokeLife,0.3}},
        BlueOverLife = {{0, 0.15}, {0.25, 0.52}}, -- {{0, 0}, {1*fireLife/smokeLife,0.3}},
        AlfaOverLife = {{0, 0}, {0.01, 1}, {0.92, 0.06}, {1, 0}}, -- {{0.0, 0.0}, {1*fireLife/smokeLife, 1.0}, {1, 0}},
    },
}
