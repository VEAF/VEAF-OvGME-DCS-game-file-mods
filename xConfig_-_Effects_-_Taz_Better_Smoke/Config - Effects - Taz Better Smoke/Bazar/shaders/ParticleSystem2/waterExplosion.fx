...
static const float3 SplashColor = {0.26, 0.41, 0.56};
...
float4 psWaterExplosion(PS_INPUT i, uniform bool bLod): SV_TARGET0
{
	...
	float4 color = 1;
	color.a = norm.a * lerp(1, texFoam.Sample(gTrilinearWrapSampler, float3(i.uv, LERP_FACTOR)).r, LERP_FACTOR) * OPACITY * 0.25; //Taz1004 Opacity
